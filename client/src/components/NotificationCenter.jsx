  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="relative p-2 text-usb-dark hover:bg-usb-gray-100 rounded-lg transition-colors"
      >
        <Bell className="w-6 h-6" />
        {unreadCount > 0 && (
          <span className="absolute -top-1 -right-1 bg-usb-orange-500 text-usb-white text-xs rounded-full h-5 w-5 flex items-center justify-center font-bold">
